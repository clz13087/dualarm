...
# y
axes[1,0].plot(time_user, y_user, c='darkorange', label='user')
axes[1,0].plot(time_robot, y_robot, c='dimgray', label='robot')
...
# z
axes[2,0].plot(time_user, z_user, c='darkorange', label='user')
axes[2,0].plot(time_robot, z_robot, c='dimgray', label='robot')
...
# roll
axes[0,1].plot(time_user, roll_user, c='darkorange', label='user')
axes[0,1].plot(time_robot, roll_robot, c='dimgray', label='robot')
...
# yaw
axes[2,1].plot(time_user, yaw_user, c='darkorange', label='user')
axes[2,1].plot(time_robot, yaw_robot, c='dimgray', label='robot')
