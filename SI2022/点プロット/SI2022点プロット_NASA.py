...
OP4 = [addr for addr in dat if 'OP3_1' in addr[0]]
OP5 = [addr for addr in dat if 'OP3_2' in addr[0]]
...
height1 = [OP1list[0],OP2list[0],OP3list[0],OP4list[0],OP5list[0]]
height2 = [OP1list[1],OP2list[1],OP3list[1],OP4list[1],OP5list[1]]
height3 = [OP1list[2],OP2list[2],OP3list[2],OP4list[2],OP5list[2]]
height4 = [OP1list[3],OP2list[3],OP3list[3],OP4list[3],OP5list[3]]
