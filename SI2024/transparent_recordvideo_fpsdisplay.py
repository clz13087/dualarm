...
while True:
    ...
    # ゲージの描画処理
    gauge_width = int((robotside_fps / 0.08) * 1200)  # 190FPSを最大としたゲージ幅
    cv2.rectangle(overlay_frame, (10, display_height - 30), (10 + gauge_width, display_height - 10), (0, 255, 0), -1)
    cv2.putText(overlay_frame, f"difference: {robotside_fps*1000:.2f}mm", (10, display_height - 40), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1)
